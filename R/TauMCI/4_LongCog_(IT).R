...
write.csv(coef(Longcogn_PACC)$ID, './5_25_22/long2_coefficients_PACC_YrBl_IT_6-14.csv', row.names = TRUE)
...
cogn_group1<- cogn_long[which(cogn_long$Biomarker_group_IT=="1"),]
...
ggsave("./5_25_22/6-14_long_cogn_ADRC_spaghetti_group1_bystatus_IT.png", plot = Logncogn_PACC_LME_spaghetti_group1_bystatus, device = "png", width = 80, height = 20, units = "cm", dpi = 500)

#select just those in group 2 (i.e., A+T-)

cogn_group2<- cogn_long[which(cogn_long$Biomarker_group_IT=="2"),]
...
ggsave("./5_25_22/6-14_long_cogn_ADRC_spaghetti_group2_bystatus_IT.png", plot = Logncogn_PACC_LME_spaghetti_group2_bystatus, device = "png", width = 80, height = 20, units = "cm", dpi = 500)
...
cogn_group3<- cogn_long[which(cogn_long$Biomarker_group_IT=="3"),]
...
ggsave("./5_25_22/6-14_long_cogn_ADRC_group3_line_IT.png", plot = Logncogn_PACC_group3_line, device = "png", width = 80, height = 20, units = "cm", dpi = 500)
...
ggsave("./5_25_22/6-14_long_cogn_ADRC_spaghetti_group3_IT.png", plot = Logncogn_PACC_LME_spaghetti_group3, device = "png", width = 80, height = 20, units = "cm", dpi = 500)


#select just those in group 4 (i.e., A-T-)

cogn_group4<- cogn_long[which(cogn_long$Biomarker_group_IT=="4"),]
...
ggsave("./5_25_22/6-14_long_cogn_ADRC_spaghetti_group4_bystatus_IT.png", plot = Logncogn_PACC_LME_spaghetti_group4_bystatus, device = "png", width = 80, height = 20, units = "cm", dpi = 500)
...
ggsave("./5_25_22/Long_Biomarker_group_IT_6-14.png", plot = longcogn_ADRC, device = "png", width = 80, height = 20, units = "cm", dpi = 500)
